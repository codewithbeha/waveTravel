    ...
    >
      ...
      >
        <CampSite 
          ...
          title="Jal Beach Camp"
          subtitle="Jal, Albania"
          peopleJoined="500+ Joined"
        />
        <CampSite
        backgroundImage="bg-bg-img-2"
        title="Baro Beach Camp"
        subtitle="Vlore, Albania"
        peopleJoined="5000+ Joined"
         />    
      </div>

      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734]px 
        xl:rounded-5xl  xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            very large. That's why we are here for those of you who want to
            start an adventure
          </p>
