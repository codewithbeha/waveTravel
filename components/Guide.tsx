  ...
  return (
    <section className="flexCenter flex-col">
      ...
      w-full pb-24">
        ...
        <p className="uppercase regular-18 -mt01 mb-3 text-green-50">
          We are here for you
        </p>
        ...
        rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Jal Beach Albania</p>
            </div>

            <div className="flex w-full flex-col">
                <p className="regular-16 text-gray-20">Start Track</p>
              <p className="bold-20 mt-2 whitespace-nowrap">Himara</p>
            </div>
          </div>
        </div>
      </div>
